...
function love.conf(t)
    t.title = "Duet in the City"-- The title of the window the game is in (string)
    t.author = "hewills"        -- The author of the game (string)
    t.url = "n/a"                 -- The website of the game (string)
